 ...
 * <p>
 * Static pages are pages which are located in the WEB-INF/velocity/page/static/ folder. They don't
 * need additional data from the controller and therefore can be called with this generic
 * controller.
 *
